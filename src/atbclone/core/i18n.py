...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "win_edit_notes_placeholder": {
        "en": "e.g. account name, purpose, region",
        "zh": "如：账号名、用途、地区",
        "zh_TW": "如：帳號名稱、用途、地區",
        "ja": "例：アカウント名、用途、地域",
        "ko": "예: 계정 이름, 용도, 지역",
        "de": "z. B. Kontoname, Zweck, Region",
        "fr": "p. ex. nom du compte, usage, région",
        "ru": "напр. имя аккаунта, назначение, регион",
        "es": "p. ej. nombre de cuenta, propósito, región",
    },
    ...
    "update_error_short": {
        ...
        "fr": "❌ Échec de la vérification de mise à jour",
        "ru": "❌ Ошибка проверки обновлений",
        "es": "❌ Error al buscar actualizaciones",
    },
    "update_error_timeout": {
        "en": "❌ Check failed: Timeout",
        "zh": "❌ 检查更新失败: 网络超时",
        "zh_TW": "❌ 檢查更新失敗: 網路超時",
        "ja": "❌ 確認失敗: タイムアウト",
        "ko": "❌ 확인 실패: 시간 초과",
        "de": "❌ Prüfung fehlgeschlagen: Zeitüberschreitung",
        "fr": "❌ Échec de vérification : Délai dépassé",
        "ru": "❌ Ошибка проверки: Время ожидания истекло",
        "es": "❌ Error de verificación: Tiempo de espera agotado",
    },
    "update_error_network": {
        "en": "❌ Check failed: Network error",
        "zh": "❌ 检查更新失败: 网络连接异常",
        "zh_TW": "❌ 檢查更新失敗: 網路連線異常",
        "ja": "❌ 確認失敗: ネットワークエラー",
        "ko": "❌ 확인 실패: 네트워크 오류",
        "de": "❌ Prüfung fehlgeschlagen: Netzwerkfehler",
        "fr": "❌ Échec de vérification : Erreur réseau",
        "ru": "❌ Ошибка проверки: Ошибка сети",
        "es": "❌ Error de verificación: Error de red",
    },
    "update_error_http": {
        "en": "❌ Check failed: HTTP {code}",
        "zh": "❌ 检查更新失败: HTTP {code}",
        "zh_TW": "❌ 檢查更新失敗: HTTP {code}",
        "ja": "❌ 確認失敗: HTTP {code}",
        "ko": "❌ 확인 실패: HTTP {code}",
        "de": "❌ Prüfung fehlgeschlagen: HTTP {code}",
        "fr": "❌ Échec de vérification : HTTP {code}",
        "ru": "❌ Ошибка проверки: HTTP {code}",
        "es": "❌ Error de verificación: HTTP {code}",
    },
